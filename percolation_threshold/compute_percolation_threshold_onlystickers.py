...
for i,temp in enumerate(T):
    ...
    for boxsize in L:
        ...
        pattern = f"./data_phic_Nchains10000_Gaurav6e11_usingYFR/{variant}/clusterresults_T{temp}_L{boxsize}_frame*.npy"
...
plt.tight_layout()
plt.savefig('./phic_vs_density_Nchains10000_WTARO_usingYFR.pdf',bbox_inches='tight')
...
plt.savefig('./phiperc_vs_T_Nchains10000_WTARO_usingYFR.pdf',bbox_inches='tight')
